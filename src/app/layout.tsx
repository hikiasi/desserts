...
export const metadata: Metadata = {
  ...
  description: "Ледяной десерт для кафе, ресторанов, магазинов в Калининграде. Профитроли, торты, ЗОЖ-линейка. Прямые поставки от производителя. Срок хранения 180 дней. Доставка от 2000₽ бесплатно.",
};
