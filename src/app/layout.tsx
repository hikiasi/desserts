...
export const metadata: Metadata = {
  title: "Ледяной десерт — премиальные десерты в Калининграде",
  description: "Ледяной десерт для кафе, ресторанов, магазинов в Калининграде. Профитроли, мини торты, ЗОЖ-линейка. Прямые поставки от производителя. Срок хранения 180 дней. Доставка от 2000₽ бесплатно.",
};
