import { Cake, Send, MapPin, Mail, Phone } from "lucide-react"
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a href="https://vk.com/club233930785" target="_blank" className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 hover:bg-primary hover:text-white transition-all" aria-label="ВКонтакте">
        ...
        <div className="pt-8 border-t border-slate-50 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-xs text-slate-400">
            © {new Date().getFullYear()} Ледяной десерт — замороженные десерты, профитроли и мини торты для кафе и ресторанов в Калининграде. Все права защищены.
          </div>
