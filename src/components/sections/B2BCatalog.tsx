                  ...
                  <AccordionContent className="pb-8">
                    ...
                    <div className="mt-8 p-6 bg-white/40 backdrop-blur-sm rounded-2xl border border-slate-100">
                        <p className="text-sm text-slate-600 leading-relaxed italic">
                            <b>Примечание:</b> {cat === 'Профитроли' ? 'Наш хит! Срок хранения 180 дней. Разморозка 15 мин.' : cat === 'ЗОЖ-линейка' ? 'Тренд 2026 года! Увеличивает охват аудитории на 30%.' : 'Классические вкусы, которые всегда в спросе.'}
                        </p>
                    </div>
                  </AccordionContent>
                </AccordionItem>
