...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Мы предлагаем фиксированные честные цены для всех партнеров. Однако при очень крупных регулярных заказах мы готовы обсудить индивидуальные условия сотрудничества."
  },
  {
  ...
  },
  {
    ...
    answer: "Да! После первых 3 успешных заказов открываем отсрочку оплаты 7 дней. Первые 3 заказа — оплата при получении. Плюс скидка 20% на 1-ую партию от 2000₽."
  },
  {
